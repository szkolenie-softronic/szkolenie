...
public class AkcjaWytnij extends AbstractAction {

	static ImageIcon icon;
	static {
		try {
			InputStream stream = System.class.
					getResourceAsStream("/pl/softronic/szkolenie/gui/tedit/Editing-Cut-Filled-icon.png");
	...
	public void actionPerformed(ActionEvent a) {
		...
		TEditMain.czyPlikJestAktualny = false;
